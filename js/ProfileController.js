...
app.controller('ProfileController', function ($scope,$modal,$mdDialog,commonpostService,$state,$timeout,$http,getfitService,$localStorage,$location,fetchrecordsCMSService,updateProfileService,removeImageService,getMatercmsService,getProfileService,checkjobService, $stateParams) { 
